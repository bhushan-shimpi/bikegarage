        ...
        <div className="hidden md:grid md:grid-cols-5 gap-4 lg:gap-5 relative">
          {steps.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="relative bg-[#181818] border border-[#2B2B2B] rounded-xl p-4 lg:p-5 flex flex-col justify-between hover:border-[#F5B900] transition-all duration-300 group"
              >
                {/* Step Number & Icon */}
