...
export const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    importantNote: 'If any additional spare part needs to be replaced during servicing, the cost will be added separately to the final bill. No additional work will be carried out without the customer’s prior approval.',
    estimatedTime: '3 - 4 Hours',
    priceStartingAt: '₹1,820',
    category: 'maintenance',
  ...
  },
  {
    ...
    totalPackagePrice: '₹18,850 - ₹25,000+',
    benefits: [
    ...
    importantNote: 'Evdhe paise fix lagtil. Other spare parts takayche astil tr separate charges dyave lagel. 100cc bike la Showroom condition karaychi aslyas minimum ₹20,000+ evdha kharch yeu shakto, aani 150cc bike la minimum ₹25,000+ evdha kharch yeu shakto.',
    estimatedTime: '1 - 3 Weeks',
    priceStartingAt: '₹18,850+',
    category: 'repair',
